...
namespace EasyResourceManager
{
    ...
    public class ResourcesManager : ScriptableObject
    {
        ...
        [HideInInspector]
        public List<Attribute.AttributeObj> attributesControl = new List<Attribute.AttributeObj>();
        [HideInInspector]
        public List<Resource.ResourceObj> resourcesControl = new List<Resource.ResourceObj>();
        ...
        [SerializeField]
        private Resource.ResourceObj myCustomResource;
        ...
        [Serializable]
        private struct EditableResource
        {
            public string name;
            public bool editThis;
        ...
        [NonReorderable]
        [SerializeField]
        private List<EditableResource> editResource;
